    ...
    <aside class="hidden md:block w-60 shrink-0">
        <form action="{{ route('customer.shop') }}" method="GET">
            <div class="bg-white rounded-2xl border border-gray-100 p-5 sticky top-24">
                ...
                <div class="mb-5">
                    ...
                    <div class="space-y-1.5">
                        <label class="flex items-center gap-2 cursor-pointer group">
                            ...
                            <span class="text-sm text-gray-700 group-hover:text-indigo-600">All Categories</span>
                        </label>
                ...
                <button type="submit"
                        class="w-full bg-indigo-600 text-white py-2 rounded-xl text-sm font-semibold
                ...
                <a href="{{ route('customer.shop') }}"
                   class="block text-center text-sm text-gray-500 hover:text-red-500 mt-2">
                    Clear filters
                </a>
                @endif
            </div>
            ...
            <a href="{{ route('customer.product', $product->slug) }}"
               class="bg-white rounded-2xl border border-gray-100 overflow-hidden 
                ...
                <div class="aspect-square bg-gray-50 overflow-hidden relative">
                    ...
                    <span class="absolute top-2 left-2 bg-red-500 text-white text-xs font-bold px-2 py-0.5 rounded-lg">SALE</span>
                    @endif
                </div>
