...
<div class="mb-4">
    <nav class="flex items-center gap-2 text-sm text-gray-400">
        <a href="{{ route('customer.dashboard') }}" class="hover:text-indigo-600">Home</a>
        <span>/</span>
        <a href="{{ route('customer.shop') }}" class="hover:text-indigo-600">Shop</a>
        <span>/</span>
        <a href="{{ route('customer.shop', ['category' => $product->category_id]) }}"
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        <div class="flex flex-col">
            ...
            <div class="flex items-center gap-2 mb-3">
                ...
                <span class="text-xs bg-red-50 text-red-500 font-semibold px-3 py-1 rounded-full">
                    SALE
                </span>
                @endif
            </div>
            ...
            @else
            <button disabled
                    class="w-full bg-gray-100 text-gray-400 py-3.5 rounded-xl font-bold text-sm cursor-not-allowed">
                Out of Stock
            </button>
            @endif
            ...
            <div class="grid grid-cols-3 gap-3 mt-6 pt-6 border-t border-gray-100">
                <div class="flex flex-col items-center gap-1 text-center">
                    ...
                    <span class="text-xs text-gray-500 font-medium">Secure Payment</span>
                </div>
                <div class="flex flex-col items-center gap-1 text-center">
                    <svg class="w-5 h-5 text-indigo-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <span class="text-xs text-gray-500 font-medium">Free Shipping</span>
                </div>
                <div class="flex flex-col items-center gap-1 text-center">
                    <svg class="w-5 h-5 text-indigo-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <span class="text-xs text-gray-500 font-medium">Easy Returns</span>
                </div>
            </div>
        </div>
    </div>
...
<div>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <a href="{{ route('customer.product', $item->slug) }}"
